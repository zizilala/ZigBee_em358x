...
EmberRf4cePairingTableEntry *emRf4cePairingTable = (EmberRf4cePairingTableEntry *) &emAvailableMemory[END_emFrameCountersTable];
int8u emRf4cePairingTableSize = EMBER_RF4CE_PAIRING_TABLE_SIZE;
#define END_emRf4cePairingTable         \
  (END_emFrameCountersTable + align(EMBER_RF4CE_PAIRING_TABLE_SIZE * sizeof(EmberRf4cePairingTableEntry)))
...
void emberRf4cePairCompleteHandler(EmberStatus status, int8u pairingIndex){}
#endif
