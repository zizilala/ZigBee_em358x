...
extern const int16s halSystemXtalKHz;
 ...
 */
int16u halPeripheralClockKHz(void);
...
#define MAC_TIMER_TICKS(microseconds) \
  ((((int32u)(microseconds) * (halPeripheralClockKHz() / 250)) + 47) / 48)
...
#define MAC_TIMER_US(ticks) \
  (((((int32u)(ticks) * 48000) / (halPeripheralClockKHz() / 250)) + 500) / 1000)
