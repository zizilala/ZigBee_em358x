...
enum HalBoardLedPins {
  BOARDLED0 = PORTA_PIN(6),         //LED_G 
  /*BOARDLED1 = PORTA_PIN(7),*/
  BOARDLED1 = PORTC_PIN(7),         //LED_R By Ray 150120
 ...
 */
#define BUTTON0             PORTB_PIN(6)        //TAMPER_SW
/**
 ...
 */
#define BUTTON1             PORTC_PIN(6)        //MAGNETIC_SW
/**
...
extern int8u gpioOutPowerUp[3];             //3 port(A, B & C),  per port (8bits) Ray 150120
...
int16u gpioCfgPowerUp[6] = {                                                  \
                           ...
                           /*(GPIOCFG_IN_PUD     <<PB6_CFG_BIT)| By Ray 150120*/\
                           ...
                           /*(PWRUP_CFG_BUTTON1  <<PC6_CFG_BIT)| By Ray 150120*/\
                             (GPIOCFG_IN         <<PC6_CFG_BIT)|              \
                           /*(CFG_TEMPEN         <<PC7_CFG_BIT)) By Ray 150122*/\
                             (PWRUP_CFG_LED_RHO  <<PC7_CFG_BIT))                \
                           }
...
int8u gpioOutPowerUp[3] = {                                               \
                          ...
                          /*(GPIOOUT_PULLUP     <<PB6_BIT)|  By Ray 150120*/ \
                            (GPIOOUT_PULLDOWN   <<PB6_BIT)|               \
                            (0                  <<PB7_BIT)),              \
                           ...
                           /*(PWRUP_OUT_BUTTON1  <<PC6_BIT)| By Ray 150120*/\
                            (GPIOOUT_PULLDOWN   <<PC6_BIT)|                \
                            /* Temp Sensor default on */                  \
                           /*(1                  <<PC7_BIT))By Ray 150122*/\
                            (PWRUP_OUT_LED_RHO  <<PC7_BIT))                 \
                          }
...
int8u gpioOutPowerDown[3] = {                                               \
                            ...
                            /*(PWRDN_OUT_BUTTON1  <<PC6_BIT)| By Ray 150120*/\
                              (GPIOOUT_PULLDOWN   <<PC6_BIT)|               \
                              /* Temp Sensor off */                         \
                              (0                  <<PC7_BIT))/*By Ray 150122*/\
                            }
