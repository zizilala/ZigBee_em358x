...
extern int16u emberCountersThresholds[EMBER_COUNTER_TYPE_COUNT];
#endif
 ...
 */
extern int16u emberMultiNetworkCounters[EMBER_MAX_SUPPORTED_NETWORKS]
...
void emberSetCounterThreshold(EmberCounterType type, int16u threshold);
