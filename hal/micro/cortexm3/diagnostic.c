...
int16u halInternalCrashHandler(void)
{
  ...
  if ( ((int32u)sp >= c->mainStackBottom)
       && ((int32u)sp <= ((int32u)STACK_SEGMENT_END - (8*sizeof(int32u)))) ) { 
  ...
  for (i = 0, s = (int32u *)STACK_SEGMENT_END; s > sEnd; ) {
    data = *(--s);
