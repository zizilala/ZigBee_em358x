...
extern const EmAfNetwork emAfNetworks[];

// The current network.
extern const EmAfNetwork *emAfCurrentNetwork;
 ...
 */
int8s emberAfCompareValues(int8u* val1, int8u* val2, int8u len, boolean signedNumber);
 ...
 *        is associated with a client cluster or ::EMBER_AF_SERVER_CLUSTER_TICK
 *        otherwise.
 * @param timeMs the number of milliseconds until the event should be called.
 ...
 * less than 16 bits large (i.e. max value for "delay" is 0x7FFF).
 */
